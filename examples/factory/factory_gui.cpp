...
void ui_begin()
{
    ...
    lv_obj_set_size(hour_cout, 225, 220);
    lv_obj_align(hour_cout, LV_ALIGN_CENTER, -145, 0);
    ...
    lv_obj_set_size(min_cout, 225, 220);
    lv_obj_align(min_cout, LV_ALIGN_CENTER, 145, 0);
